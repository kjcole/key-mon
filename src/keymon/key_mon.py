...
class KeyMon:
    ...
    """
        ...
        self.enabled = dict(
            [(img, self.get_option(cstrf(img.lower))) for img in self.IMAGES]
        )
    ...
    def do_screenshot(self):
        ...
        screenshot = Gdk.pixbuf_get_from_window(Gdk.get_default_root_window(),
                                                0, 0, w, h)
    ...
    def create_names_to_fnames(self):
        ...
        ftn = {
            ...
            "BTN_MIDDLE": [self.svg_name("mouse"),
                           self.svg_name("middle-mouse")],
            "SCROLL_UP": [self.svg_name("mouse"),
                          self.svg_name("scroll-up-mouse")],
            "SCROLL_DOWN": [self.svg_name("mouse"),
                            self.svg_name("scroll-dn-mouse")],
            "REL_LEFT": [self.svg_name("mouse"),
                         self.svg_name("sroll-lft-mouse")],
            "REL_RIGHT": [self.svg_name("mouse"),
                          self.svg_name("scroll-rgt-mouse")],
            "SHIFT": [self.svg_name("shift")],
            "SHIFT_EMPTY": [self.svg_name("shift"),
                            self.svg_name("whiteout-72")],
            "CTRL": [self.svg_name("ctrl")],
            "CTRL_EMPTY": [self.svg_name("ctrl"),
                           self.svg_name("whiteout-58")],
            "META": [self.svg_name("meta"),
                     self.svg_name("meta")],
            "META_EMPTY": [self.svg_name("meta"),
                           self.svg_name("whiteout-58")],
            "ALT": [self.svg_name("alt")],
            "ALT_EMPTY": [self.svg_name("alt"),
                          self.svg_name("whiteout-58")],
            "ALTGR": [self.svg_name("altgr")],
            "ALTGR_EMPTY": [self.svg_name("altgr"),
                            self.svg_name("whiteout-58")],
            "KEY_EMPTY": [
                fix_svg_key_closure(
                    self.svg_name("one-char-template"), [("&amp;", "")]
                ),
                self.svg_name("whiteout-48")],
            "BTN_LEFTRIGHT": [self.svg_name("mouse"),
                              self.svg_name("left-mouse"),
                              self.svg_name("right-mouse")],
            "BTN_LEFTMIDDLERIGHT": [self.svg_name("mouse"),
                                    self.svg_name("left-mouse"),
                                    self.svg_name("middle-mouse"),
                                    self.svg_name("right-mouse")]
        }
        ...
        ftn.update(
            {
                ...
                "BTN_LEFTMIDDLE": [self.svg_name("mouse"),
                                   self.svg_name(f"{left_str}-mouse"),
                                   self.svg_name("middle-mouse")],
                "BTN_MIDDLERIGHT": [self.svg_name("mouse"),
                                    self.svg_name("middle-mouse"),
                                    self.svg_name(f"{right_str}-mouse")],
            }
        )
            ...
            ftn.update(
                {
                    ...
                    "KEY_BACKSPACE": [
                        fix_svg_key_closure(
                            ...
                            [
                                ("TOP", "Back"),
                                ("BOTTOM", "\N{Leftwards open-headed arrow}"),
                            ],
                        )
                    ],
                    "KEY_RETURN": [
            ...
            ftn.update(
                {
                    "KEY_SPACE": [
                        fix_svg_key_closure(
                            self.svg_name("one-line-wide"), [("&amp;", "Space")]
                        )
                    ],
                    "KEY_TAB": [
                        fix_svg_key_closure(
                            self.svg_name("one-line-wide"), [("&amp;", "Tab")]
                        )
                    ],
                    "KEY_BACKSPACE": [
                        fix_svg_key_closure(
                            self.svg_name("one-line-wide"), [("&amp;", "Back")]
                        )
                    ],
                    "KEY_RETURN": [
                        fix_svg_key_closure(
                            self.svg_name("one-line-wide"), [("&amp;", "Enter")]
                        )
                    ],
                    "KEY_CAPS_LOCK": [
                        fix_svg_key_closure(
                            self.svg_name("one-line-wide"), [("&amp;", "Capslck")]
                        )
                    ],
                    "KEY_MULTI_KEY": [
                        fix_svg_key_closure(
                            self.svg_name("one-line-wide"), [("&amp;", "Compose")]
                        )
                    ],
                }
            )
    ...
    """
        ...
        context.add_provider(self.provider,
    ...
    def create_images(self):
        self.images["MOUSE"] = two_state_image.TwoStateImage(self.pixbufs,
                                                             "MOUSE")
    ...
    def add_events(self):
        ...
        accelgroup.connect(
            key, modifier, Gtk.AccelFlags.VISIBLE, self.show_settings_dlg
        )
    ...
    """
        ...
        if begin:
            ...
            # The current self.options.no_press_fadeout interval will
            # not be timed out again.
            return False
        ...
        if code.startswith("KEY_KP"):
            ...
            if code not in self.name_fnames:
                ...
                self.name_fnames[code] = [
                    fix_svg_key_closure(self.svg_name(template),
                                        [("&amp;", letter)])
                ]
            self._handle_event(self.key_image, code, value)
            return
        ...
        if self.enabled["MOUSE"]:
            if code in self.btns:
                ...
                if self.options.emulate_middle and (
                    (self.images["MOUSE"].current == "BTN_LEFT"
                     and code == "BTN_RIGHT")
                    or (self.images["MOUSE"].current == "BTN_RIGHT"
                        and code == "BTN_LEFT")):
                    code = "BTN_MIDDLE"
    ...
    def settings_changed(self, unused_dlg):
        ...
        for img in self.IMAGES:
            self._toggle_a_key(self.images[img], img,
                               self.get_option(cstrf(img.lower)))
        self.create_buttons()
        self.layout_boxes()
    ...
    def show_about_dlg(self, *_):
        ...
        logo_paths += tuple(
            ...
            for logo_path in (os.path.expanduser("~"),
                              "/usr",
                              "/usr/local",
                              "/opt/local")
        )
...
def create_options():
    ...
    opts.add_option(opt_long="--mouse",
                    dest="mouse",
                    type="bool",
                    default=True,
                    ini_group="buttons",
    ...
    opts.add_option(opt_long="--shift",
                    dest="shift",
                    type="bool",
                    default=True,
                    ini_group="buttons",
    ...
    opts.add_option(opt_long="--scale",
                    dest="scale",
                    type="float",
                    default=1.0,
                    ini_group="ui",
                    ini_name="scale",
                    help=_("Scale the dialog. ex. 2.0 is 2 times larger, "
                           "0.5 is half the size. Defaults to %default"))
    opts.add_option(opt_long="--key-timeout",
                    dest="key_timeout",
                    type="float",
                    default=0.5,
                    ini_group="ui",
                    ...
                    help=_("Timeout before key returns to unpressed image. "
                           "Defaults to %default"))
    opts.add_option(opt_long="--mouse-timeout",
                    dest="mouse_timeout",
                    type="float",
                    default=0.2,
                    ini_group="ui",
                    ...
                    help=_("Timeout before mouse returns to unpressed image. "
                           "Defaults to %default"))
    opts.add_option(opt_long="--visible-click-timeout",
                    ...
                    help=_("Timeout before highly visible click disappears. "
                           "Defaults to %default"))
    opts.add_option(opt_long="--decorated",
                    dest="decorated",
                    type="bool",
                    ini_group="ui",
                    ini_name="decorated",
    ...
    opts.add_option(opt_long="--backgroundless",
                    dest="backgroundless",
                    type="bool",
                    ini_group="ui",
    ...
    opts.add_option(opt_long="--no-press-fadeout",
                    dest="no_press_fadeout",
                    type="float",
                    default=0.0,
                    ini_group="ui",
                    ini_name="no_press_fadeout",
                    help=_("Fadeout the window after a period with no "
                           "key press. "
                           "Defaults to %default seconds (Experimental)"))
    opts.add_option(opt_long="--only_combo",
                    dest="only_combo",
                    type="bool",
                    ini_group="ui",
                    ini_name="only_combo",
    ...
    opts.add_option(opt_long="--sticky",
                    dest="sticky_mode",
                    type="bool",
                    ini_group="ui",
                    ...
                    default=False,
                    help=_("Sticky mode"))
    opts.add_option(opt_long="--visible_click",
                    dest="visible_click",
                    type="bool",
                    ini_group="ui",
    ...
    opts.add_option(opt_long="--follow_mouse",
                    dest="follow_mouse",
                    type="bool",
                    ini_group="ui",
    ...
    opts.add_option(opt_long="--kbdfile",
                    dest="kbd_file",
                    ini_group="devices",
                    ini_name="map",
                    default=None,
                    help=_("Use this kbd filename."))
    opts.add_option(opt_long="--swap",
                    dest="swap_buttons",
                    type="bool",
                    default=False,
                    ini_group="devices",
    ...
    opts.add_option(opt_long="--emulate-middle",
                    dest="emulate_middle",
                    type="bool",
                    default=False,
                    ini_group="devices",
                    ini_name="emulate_middle",
                    help=_("When you press the left, and right mouse "
                           "buttons at the same time, it displays as "
                           "a middle mouse button click."))
    opts.add_option(opt_short="-v",
                    opt_long="--version",
                    dest="version",
                    type="bool",
                    help=_("Show version information and exit."))
    opts.add_option(opt_short="-t",
                    opt_long="--theme",
                    dest="theme",
                    type="str",
                    ini_group="ui",
                    ini_name="theme",
                    default="classic",
                    help=_('The theme to use when drawing status images '
                           '(ex. "-t apple").'))
    opts.add_option(opt_long="--list-themes",
                    dest="list_themes",
                    type="bool",
                    help=_("List available themes"))
    opts.add_option(opt_long="--old-keys",
                    dest="old_keys",
                    type="int",
                    ini_group="buttons",
                    ini_name="old-keys",
                    help=_("How many historical keypresses to show "
                           "(defaults to %default)"),
                    default=0)
    opts.add_option(opt_long="--reset",
                    dest="reset",
                    type="bool",
                    help=_("Reset all options to their defaults."),
                    default=None)
    opts.add_option(opt_short=None,
                    opt_long="--opacity",
                    type="float",
                    dest="opacity",
                    default=1.0,
    ...
    opts.add_option(opt_long="--screenshot",
                    dest="screenshot",
                    type="str",
                    default="",
...
def main():
    ...
    logging.basicConfig(
        level=loglevel,
        style="{", format="{filename} [{lineno}]: {levelname} {message}"
    )
    if loglevel is None:
