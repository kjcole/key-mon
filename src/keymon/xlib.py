...
class XEvents(threading.Thread):
    ...
    def start_listening(self):
        ...
        # Don't understand this, how can we free
        # the context yet still use it in Stop?
    ...
    """
        if value == 2:
            self.events.append(XEvent("EV_MOV", 0, 0,
            ...
            self.events.append(
                XEvent("EV_REL",
                       0,
                       XEvents._butn_to_code.get(event.detail,
                                                 f"BTN_{event.detail}"),
                       value)
            )
        else:
    ...
    """
        ...
        self.events.append(
            XEvent("EV_KEY", event.detail - 8,
                   self.keycode_to_symbol[keysym], value)
        )
