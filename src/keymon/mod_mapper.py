...
SHORT_NAME = {"BACKSPACE": "\N{Leftwards open-headed arrow}",
...
def safely_read_mod_map(fname, kbd_files):
  ...
  """
    ...
    try:
        ...
        if DEFAULT_KBD:
            logging.info(f"setxkbmap returns a keyboard layout_variant: "
                         f"{DEFAULT_KBD}")
            DEFAULT_KBD += ".kbd"
    except OSError:
        pass
